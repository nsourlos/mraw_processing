...
def save_to_hdf5(images, filename, compression_level=1):
    """
...
def batch_convert_mraw_to_hdf5(main_path, output_path, compression_level=1):
    """
    ...
    for illumination in os.listdir(main_path):
        ...
        for root, dirs, files in os.walk(illumination_path):
            ...
            for file in files:
                ...
                # Load and save video
                images, info = load_mraw_video(input_file)
                if images is not None:
                    save_to_hdf5(images, output_file, compression_level)
                    processed_count += 1
